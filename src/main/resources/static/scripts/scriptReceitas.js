...
const RECIPES = [
    ...
    // ===== RECEITA 5 =====
    {
        ...
        duration: "90 min",
        instructorNote: "Orientar os alunos sobre a montagem das camadas e o ponto correto do molho.",
    ...
    // ===== RECEITA 6 =====
    {
        ...
        duration: "50 min",
        instructorNote: "Demonstrar a importância de pré-aquecer o forno antes de iniciar o preparo.",
    ...
    // ===== RECEITA 7 =====
    {
        ...
        duration: "40 min",
        instructorNote: "Explicar o ponto correto da massa antes de modelar os pães.",
    ...
    // ===== RECEITA 8 =====
    {
        ...
        duration: "30 min",
        instructorNote: "Demonstrar a montagem e a emulsificação do molho Caesar.",
    ...
    // ===== RECEITA 9 =====
    {
        ...
        duration: "60 min",
        instructorNote: "Orientar sobre o corte dos ingredientes e o controle da temperatura durante o cozimento.",
            ...
            <div class="instructor-note-box">
                ...
                <div class="note-box-header">
                    ...
                    <div class="note-title">
                        ...
                        <h3>
                            OBSERVAÇÕES DO INSTRUTOR PARA ESTA AULA
                        </h3>
                ...
                <div class="note-box-body" id="noteViewMode">
                    ...
                    <p id="instructorNoteText">
                        ...
                        ${
        r.instructorNote ||
        'Nenhuma observação registrada para esta receita.'
    }
...
(function initNotifications() {
    ...
    const clear =
        document.getElementById('notif-clear');
