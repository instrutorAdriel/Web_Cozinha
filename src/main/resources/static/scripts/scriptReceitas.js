...
const RECIPES = [
    {
        ...
        steps:[
            {title:"Hidrate o funghi", text:"Deixe o funghi secchi de molho em água morna. Escorra e pique."},
            {title:"Refogue a cebola", text:"Em uma panela, derreta 1 colher de manteiga e refogue a cebola até ficar transparente."},
            {title:"Toste o arroz", text:"Adicione o arroz arbóreo e mexa até ficar levemente translúcido."},
    ...
    },
    {
        ...
        steps:[
            {title:"Dessalgue as carnes", text:"Deixe a carne seca de molho, trocando a água algumas vezes."},
            {title:"Cozinhe o feijão", text:"Cozinhe o feijão preto na panela de pressão até ficar macio."},
            {title:"Doure as carnes", text:"Em uma panela grande, doure a linguiça e a costelinha."},
            {title:"Junte tudo", text:"Adicione o feijão cozido, a carne seca desfiada, louro, cebola e alho. Cozinhe em fogo baixo."},
            {title:"Finalize e sirva", text:"Ajuste o sal, retire o excesso de gordura e sirva com arroz branco, couve refogada e farofa."}
        ]
    },
    {
        ...
        steps:[
            {title:"Prepare o arroz", text:"Cozinhe o arroz e tempere com vinagre de arroz, açúcar e sal ainda quente."},
            {title:"Corte o salmão", text:"Corte o salmão fresco em tiras finas e uniformes."},
            {title:"Monte os rolinhos", text:"Espalhe o arroz sobre a alga nori, adicione o salmão e enrole com a esteira de bambu."},
            {title:"Corte e sirva", text:"Corte os rolinhos em peças iguais e sirva com shoyu, gengibre e wasabi."}
        ]
    },
    {
        ...
        steps:[
            {title:"Refogue os aromáticos", text:"Refogue a cebola e o alho até dourarem levemente."},
            {title:"Adicione as especiarias", text:"Junte o curry em pó e a páprica, mexendo para liberar o aroma."},
            {title:"Adicione o grão-de-bico e o leite de coco", text:"Misture bem e deixe cozinhar em fogo médio-baixo."},
            {title:"Finalize", text:"Ajuste o sal, finalize com coentro fresco picado e sirva com arroz basmati."}
        ]
    },
    {
        ...
        steps:[
            {title:"Tempere a carne", text:"Tempere a carne de porco com sal, cominho e alho amassado."},
            {title:"Cozinhe lentamente", text:"Cozinhe a carne com suco de laranja em fogo baixo até ficar bem macia."},
            {title:"Desfie e doure", text:"Desfie a carne e leve à frigideira quente para dourar as bordas."},
            {title:"Monte os tacos", text:"Sirva a carne em tortillas quentes com cebola roxa, coentro e limão."}
        ]
    },
    {
        ...
        steps:[
            {title:"Corte os vegetais", text:"Corte todos os vegetais em fatias finas e uniformes."},
            {title:"Refogue a base", text:"Refogue cebola e alho no azeite até perfumar."},
            {title:"Monte em camadas", text:"Disponha as fatias de vegetais alternadas sobre a base de tomate."},
            {title:"Asse lentamente", text:"Leve ao forno coberto com papel alumínio até os vegetais ficarem macios."}
        ]
    }
];
...
// ===== NOTIFICAÇÕES (painel funcional, igual à Home) =====
(function () {
    ...
    // Nesta tela não há geração de notificações (mantém apenas a
    // estrutura/interação do painel, igual à Home).
    ...
    if (clear) clear.addEventListener('click', marcarTodasLidas);
    ...
    render(); // define o estado inicial do badge
})();